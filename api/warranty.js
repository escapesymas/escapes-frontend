  ...
  `;
    ...
    try {
        ...
        await transporter.sendMail({
            from: '"Portal Garantías" <garantiasydevoluciones@escapesymas.com>',
            to: 'garantiasydevoluciones@escapesymas.com', // Se envía a sí mismo
        ...
        await transporter.sendMail({
            from: '"Escapes y Más" <garantiasydevoluciones@escapesymas.com>',
            to: email, // Al cliente
