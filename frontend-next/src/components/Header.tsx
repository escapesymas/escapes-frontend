      ...
      <div className="container mx-auto px-4 md:px-6 h-14 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 md:gap-4 shrink-0">
          ...
          <nav className="hidden md:flex items-center gap-5 ml-2">
            ...
            <span className="text-xs font-mono font-bold uppercase tracking-wider cursor-pointer text-foreground hover:text-accent-text transition-colors">Paddock</span>
