  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col md:flex-row font-sans">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-10 overflow-y-auto max-w-7xl mx-auto w-full">
        ...
        {/* ORDERS TAB */}
        {activeTab === 'orders' && (() => {
          // Filter orders client-side for dynamic real-time searches
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              ...
              <div className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest bg-zinc-950 border border-zinc-900 px-4 py-3.5 rounded-xl">
                Mostrando <strong className="text-zinc-300 font-mono">{products.length}</strong> de <strong className="text-racing-orange font-mono">103.993</strong> productos
              </div>
            </div>
                ...
                <tbody className="divide-y divide-zinc-900/50">
                  {users.length === 0 ? (
                    ...
                    <tr key={u.id} className="hover:bg-white/[0.01]">
                      ...
                      <td className="py-4 font-bold text-white">{u.firstName || 'Cliente'} {u.lastName || ''}</td>
                      ...
                      <td className="py-4">
                        <span className={`px-2.5 py-0.5 rounded text-[9px] font-black uppercase tracking-wider ${
                          u.role === 'admin' ? 'bg-red-950/20 text-red-500 border border-red-900/30' : 'bg-zinc-900 text-zinc-400 border border-zinc-800'
                        }`}>
                          {u.role || 'customer'}
                        </span>
                      </td>
          ...
          <div className="space-y-3 bg-zinc-900/40 p-4 rounded-xl border border-zinc-800/40 animate-fade-in">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 pt-2 text-[10px] uppercase font-bold text-zinc-500">
              <div>
                ...
                <span className="block text-white mt-0.5 truncate max-w-[120px] font-mono" title={images.currentSku}>
                  {images.currentSku || 'Buscando...'}
                </span>
              </div>
              <div>
