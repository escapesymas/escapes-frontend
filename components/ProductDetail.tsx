...
import { ArrowLeft, CheckCircle, Truck, ShieldCheck, Star, Minus, Plus, ShoppingCart, Hash, AlertCircle } from 'lucide-react';
...
export const ProductDetail: React.FC<ProductDetailProps> = ({ product, onBack, onAddToCart }) => {
  ...
  // Lógica de Fallback para la descripción:
  // Si no hay descripción corta, usamos la descripción larga (si existe).
