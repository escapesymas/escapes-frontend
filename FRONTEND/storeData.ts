...
export const WOO_CONFIG = {
  ...
  consumerKey: "", // PROTECTED: Las credenciales reales están en el backend (server.js)
  consumerSecret: "" // PROTECTED: Las credenciales reales están en el backend (server.js)
};
